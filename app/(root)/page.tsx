  ...
  return (
    <div className="flex-center flex-col items-center w-full">
      <section className="flex-center flex-col my-20">
        <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.15] sm:text-6xl sm:leading-[1.15] text-center">
        ...
        <div className="flex-gap justify-center mt-6">
          <Link className={cn(buttonVariants({variant: "default"}), "bg-black dark:bg-white dark:hover:bg-gray-200")} href={"/register"}>
            Get started
          </Link>
